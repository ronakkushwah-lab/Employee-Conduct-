...
class Salary(models.Model):
    ...
    def get_absolute_url(self,company_id, company_staff_id):
        # return reverse(f'/managerpayroll/msalary-detail/{company_id}/{company_staff_id}')
        return reverse('msalary-detail',{'company_id':company_id,'company_staff_id':company_staff_id},kwargs={'pk': self.pk})

        verbose_name = 'Salary'
        verbose_name_plural = 'Salaries'

    def __str__(self):
        return f"{self.manager} salary"
